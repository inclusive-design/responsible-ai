...
examples:
  education:
    - title: ''
      example: Admissions systems that rely on patterns such as continuous enrollment or test performance may disadvantage students whose records reflect disability-related disruptions. These systems may interpret gaps or variations as risk factors, even when they reflect real barriers or accommodation needs.
  employment:
    - title: ''
